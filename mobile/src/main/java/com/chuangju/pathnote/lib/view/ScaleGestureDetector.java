...
public class ScaleGestureDetector {
    ...
    private MultiTouchListener.Vector2D mCurrSpanVector;
    ...
    public ScaleGestureDetector(OnScaleGestureListener listener) {
        mListener = listener;
        mCurrSpanVector = new MultiTouchListener.Vector2D();
    }
    ...
    public MultiTouchListener.Vector2D getCurrentSpanVector() {
