 ...
 * A circle.
 */
public class Circle extends BaseDraw {

    public Circle(Context context) {
        super(context, DrawingType.Circle);
    }

    public Circle(Context context, Attributes attributes) throws Exception {
    ...
    public void fingerMove(float x, float y) {
        ...
        mPath.addCircle(rectF.centerX(), rectF.centerY(), Math.min((rectF.bottom - rectF.top) / 2, (rectF.right - rectF.left) / 2), Direction.CW);
    }
